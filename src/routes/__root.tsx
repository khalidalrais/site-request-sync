...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "BuildFlow — Procurement Requests" },
      {
        name: "description",
        content:
          "Construction ERP dashboard to track site material requests from submission through approval, order, and delivery.",
      },
      { property: "og:title", content: "BuildFlow — Procurement Requests" },
      {
        property: "og:description",
        content:
          "Replace WhatsApp chaos with a single source of truth for engineers, PMs, and procurement.",
      },
