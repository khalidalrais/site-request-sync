...
export const seedRequests: Request[] = [
  ...
  // Historical committed volume for BOQ-03.04 (C30 concrete, budget 850 m³) —
  // seeded so the Insights panel flags this line as overrun-projected.
  {
    id: "REQ-0009",
    item: "C30 ready-mix concrete",
    qty: 200,
    ...
    status: "Received",
    history: [
      { at: day(-22), actor: "Eng. A. Khan", action: "Submitted request" },
      { at: day(-21), actor: "PM Sara Khan", action: "Approved" },
      { at: day(-20), actor: "Procurement", action: "Marked ordered", comment: "PO-8790" },
      { at: day(-19), actor: "Site", action: "Marked received" },
    ],
  },
  {
    id: "REQ-0010",
    ...
    status: "Received",
    history: [
      { at: day(-10), actor: "Eng. M. Patel", action: "Submitted request" },
      { at: day(-9), actor: "PM Omar Al-Farsi", action: "Approved" },
      { at: day(-8), actor: "Procurement", action: "Marked ordered", comment: "PO-8805" },
      { at: day(-7), actor: "Site", action: "Marked received" },
    ],
  },
  {
    id: "REQ-0011",
    ...
    status: "Ordered",
    history: [
      { at: day(-6), actor: "Eng. R. Haddad", action: "Submitted request" },
      { at: day(-5), actor: "PM Nadia Rahman", action: "Approved" },
      { at: day(-4), actor: "Procurement", action: "Marked ordered", comment: "PO-8817" },
    ],
  },
  {
    id: "REQ-0012",
    ...
    status: "Approved",
    history: [
      { at: day(-2), actor: "Eng. L. Chen", action: "Submitted request" },
      { at: day(-1), actor: "PM Yusuf Malik", action: "Approved" },
    ],
  },
  // Historical rebar volume for BOQ-03.11 (budget 120 ton) — flags as "watch".
  {
    id: "REQ-0013",
    item: "Rebar T16",
    qty: 30,
    ...
    status: "Received",
    history: [
      { at: day(-20), actor: "Eng. M. Patel", action: "Submitted request" },
      { at: day(-19), actor: "PM Layla Nasser", action: "Approved" },
      { at: day(-18), actor: "Procurement", action: "Marked ordered", comment: "PO-8792" },
      { at: day(-16), actor: "Site", action: "Marked received" },
    ],
  },
  {
    id: "REQ-0014",
    ...
    status: "Ordered",
    history: [
      { at: day(-8), actor: "Eng. A. Khan", action: "Submitted request" },
      { at: day(-7), actor: "PM Sara Khan", action: "Approved" },
      { at: day(-6), actor: "Procurement", action: "Marked ordered", comment: "PO-8811" },
    ],
  },
  {
    id: "REQ-0015",
    ...
    status: "Approved",
    history: [
      { at: day(-3), actor: "Eng. R. Haddad", action: "Submitted request" },
      { at: day(-2), actor: "PM Omar Al-Farsi", action: "Approved" },
    ],
  },
];
